...
const QString trillianBody::constNameUnknown = QString(".Unknown");

trillianBody::trillianBody(int desc, marvinBody *serv, QObject *parent) :QObject(parent)
{
...
void trillianBody::onError(QAbstractSocket::SocketError socketError) const
{
...
void trillianBody::doSendCommand(quint8 comm) const
{
    QByteArray block;
...
void trillianBody::doSendUsersOnline() const
{
    QByteArray block;
    QDataStream out(&block, QIODevice::WriteOnly);
    out << (quint16)0;
